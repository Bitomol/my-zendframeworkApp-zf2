...
return array(
    'controllers' => array(
        'invokables' => array(
        	...
        	'Users\Controller\Mail' => 'Users\Controller\MailController',	
			'Users\Controller\Dokumentation' => 'Users\Controller\DokumentationController',
            ...
            'users' => array(
                ...
                'child_routes' => array(
					...
					'dokumentation' => array(
                		...
                		'may_terminate' => true,
               			'options' => array(
               				'route'    => '/dokumentation[/:action]',
               				'constraints' => array(
               					'action'     => '[a-zA-Z][a-zA-Z0-9_-]*',
               				),
               				'defaults' => array(
               					'controller' => 'Users\Controller\Dokumentation',
               					'action'     => 'index',
               				),
               			),
                	), 
					...
					'mail' => array(
						...
						'options' => array(
							...
							'defaults' => array(
								'controller' => 'Users\Controller\Mail',
								'action' => 'index',
							),
						),
					),
